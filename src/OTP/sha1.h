...
typedef u8 sha1_hash_t[SHA1_HASH_BITS / 8];
...
/** \fn sha1_lastBlock(sha1_ctx_t *state, const void* block, u16 length_b)
 ...
 */
void sha1_lastBlock (sha1_ctx_t * state, const void *block, u16 length_b);
...
/** \fn otp_sha1(sha1_hash_t *dest, const void* msg, u32 length_b)
 ...
 */
void otp_sha1 (void *dest, const void *msg, u32 length_b);
