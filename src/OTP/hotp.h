 ...
 * global config slot:
 * 
 * 1b slot sent after numlock 1b slot sent after caps lock 1b slot sent after 
 * scroll lock
 * 
 */
...
#define SLOT_PAGE_SIZE  500 // less than actual page, so we can copy it to
                            // backup page with additional info
...
#define BACKUP_PAGE_ADDRESS   (0x80000000 + OTP_FLASH_START_PAGE * FLASH_PAGE_SIZE + (512*6))   // (3 
                                                                                                // Pages) 
                                                                                                // 0x8003
