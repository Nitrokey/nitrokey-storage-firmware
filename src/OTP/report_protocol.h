...
#define STICK20_CMD_DISABLE_HIDDEN_CRYPTED_PARI         (STICK20_CMD_START_VALUE +  3)  // Not 
                                                                                        // used
...
/*
 * #define STICK20_CMD_SEND_PASSWORD_RETRY_COUNT (STICK20_CMD_START_VALUE +
 * 22)
 * 
...
/*
 * #define OUTPUT_LAST_CMD_TYPE_OFFSET 0 #define OUTPUT_CMD_CRC_OFFSET 1
 * #define OUTPUT_CMD_STATUS_OFFSET 5 #define OUTPUT_CMD_RESULT_OFFSET 6 
 */
 ...
 * 
 * typedef struct { unsigned char Counter_u8; unsigned char BlockNo_u8;
 * unsigned char SendSize_u8; unsigned char
