...
void InitStick20DebugData (u8 * output)
{
    ...
    HID_Stick20SendData_st.SendDataType_u8 =
        OUTPUT_CMD_STICK20_SEND_DATA_TYPE_NONE;
    HID_Stick20SendData_st.FollowBytesFlag_u8 = 0;  // False
    HID_Stick20SendData_st.SendSize_u8 = 0;

    memset (&HID_Stick20SendData_st.SendData_u8[0], 0,
            OUTPUT_CMD_STICK20_SEND_DATA_SIZE);

    memcpy (&output[OUTPUT_CMD_RESULT_STICK20_DATA_START],
            (void *) &HID_Stick20SendData_st,
            sizeof (HID_Stick20SendData_est));
}
...
u32 calculated_crc32;
    ...
    HID_Stick20SendData_st.SendDataType_u8 =
        OUTPUT_CMD_STICK20_SEND_DATA_TYPE_DEBUG;

    Size_u8 =
        BUFFERED_SIO_HID_GetSendChars (&HID_Stick20SendData_st.SendData_u8[0],
                                       OUTPUT_CMD_STICK20_SEND_DATA_SIZE);
    ...
    /*
     * { u8 text_au8[20]; CI_StringOut ("<"); itoa
     * (HID_Stick20SendData_st.SendCounter_u8,text_au8); CI_StringOut
     * ((char*)text_au8); CI_StringOut (">"); } 
     */
    memcpy (&output[OUTPUT_CMD_RESULT_STICK20_DATA_START],
            (void *) &HID_Stick20SendData_st,
            sizeof (HID_Stick20SendData_est));
...
u8 text_au8[10];
    ...
    if (STICK20_SEND_STATUS_PIN == Stick20HIDSendConfigurationState_u8) // This 
                                                                        // information 
                                                                        // only 
                                                                        // with 
                                                                        // pin
    ...
    Config_st.ActiveSmartCardID_u32 =
        change_endian_u32 (Config_st.ActiveSmartCardID_u32);
    Config_st.ActiveSD_CardID_u32 =
        change_endian_u32 (Config_st.ActiveSD_CardID_u32);
    ...
    Stick20HIDSendConfigurationState_u8 = STICK20_SEND_STATUS_IDLE; // Send
                                                                    // status 
                                                                    // done
...
typeStick20ProductionInfos_st Infos_st;
    ...
    Infos_st.SD_WriteSpeed_u16 =
        change_endian_u16 (Infos_st.SD_WriteSpeed_u16);
    ...
    HID_Stick20SendData_st.FollowBytesFlag_u8 = 0;  // No next data
    HID_Stick20SendData_st.SendSize_u8 =
        sizeof (typeStick20ProductionInfos_st);
...
u32 calculated_crc32;
    ...
    switch (Stick20HIDSendMatrixState_u8)
    {
        ...
        case 1:
            ...
            HID_Stick20SendData_st.SendData_u8[0] = 1;  // Set state in
                                                        // sendblock
        ...
        case 2:
            ...
            HID_Stick20SendData_st.SendData_u8[0] = 2;  // Set state in
                                                        // sendblock
        ...
        case 3:
            ...
            HID_Stick20SendData_st.SendData_u8[0] = 3;  // Set state in
                                                        // sendblock
            memcpy (&HID_Stick20SendData_st.SendData_u8[1],
        ...
        case 4:
            ...
            HID_Stick20SendData_st.SendData_u8[0] = 4;  // Set state in
                                                        // sendblock
            memcpy (&HID_Stick20SendData_st.SendData_u8[1],
        ...
        case 5:
            ...
            HID_Stick20SendData_st.SendData_u8[0] = 5;  // Set state in
                                                        // sendblock
            memcpy (&HID_Stick20SendData_st.SendData_u8[1],
        ...
        case 6:
            ...
            HID_Stick20SendData_st.SendData_u8[0] = 6;  // Set state in
                                                        // sendblock
            memcpy (&HID_Stick20SendData_st.SendData_u8[1],
        ...
        case 7:
            ...
            HID_Stick20SendData_st.SendData_u8[0] = 7;  // Set state in
                                                        // sendblock

            // Build CRC over matrix password data
            calculated_crc32 =
                generateCRC_len (Stick20HIDSendMatrixDataBlock_au8, 100 / 4);
            HID_Stick20SendData_st.SendData_u8[1] = calculated_crc32 & 0xFF;
            HID_Stick20SendData_st.SendData_u8[2] =
                (calculated_crc32 >> 8) & 0xFF;
            HID_Stick20SendData_st.SendData_u8[3] =
                (calculated_crc32 >> 16) & 0xFF;
            HID_Stick20SendData_st.SendData_u8[4] =
                (calculated_crc32 >> 24) & 0xFF;
...
u8 text[10];
                ...
                /*
                 * if (calculated_crc32==authorized_crc)
                 * cmd_read_slot(report,output); else not_authorized=1; 
                 */
                break;

            case CMD_GET_CODE:
                CI_StringOut ("Get CMD_GET_CODE\r\n");
                if ((calculated_crc32 == authorized_user_crc)
                    || (*((u8 *) (SLOTS_ADDRESS + GLOBAL_CONFIG_OFFSET + 3))
                        != 1))
                {
...
u8 text[10];
            ...
            default:
                if ((STICK20_CMD_START_VALUE > cmd_type)
                    || (STICK20_CMD_END_VALUE < cmd_type))
                {
u8 text[10];
        ...
        && (STICK20_CMD_END_VALUE > cmd_type))
    {
        if ((calculated_crc32 == received_crc32))
        {
            switch (cmd_type)
            {
                case STICK20_CMD_ENABLE_CRYPTED_PARI:
                    CI_StringOut
                        ("Get STICK20_CMD_ENABLE_CRYPTED_PARI Password=-");
                ...
                case STICK20_CMD_ENABLE_HIDDEN_CRYPTED_PARI:
                    CI_StringOut
                        ("Get STICK20_CMD_ENABLE_HIDDEN_CRYPTED_PARI Password=-");
                    CI_StringOut ((char *) &report[1]);
                    CI_StringOut ("-\r\n");
                ...
                case STICK20_CMD_DISABLE_HIDDEN_CRYPTED_PARI:
                    CI_StringOut
                        ("Get STICK20_CMD_DISABLE_HIDDEN_CRYPTED_PARI\r\n");
                ...
                case STICK20_CMD_ENABLE_FIRMWARE_UPDATE:
                    CI_StringOut
                        ("Get STICK20_CMD_ENABLE_FIRMWARE_UPDATE\r\n");
                ...
                case STICK20_CMD_EXPORT_FIRMWARE_TO_FILE:
                    CI_StringOut
                        ("Get STICK20_CMD_EXPORT_FIRMWARE_TO_FILE\r\n");
                ...
                case STICK20_CMD_FILL_SD_CARD_WITH_RANDOM_CHARS:
                    CI_StringOut
                        ("Get STICK20_CMD_FILL_SD_CARD_WITH_RANDOM_CHARS\r\n");
                ...
                case STICK20_CMD_SEND_PASSWORD_MATRIX_PINDATA:
                    CI_StringOut
                        ("Get STICK20_CMD_SEND_PASSWORD_MATRIX_PINDATA\r\n");
                ...
                case STICK20_CMD_SEND_PASSWORD_MATRIX_SETUP:
                    CI_StringOut
                        ("Get STICK20_CMD_SEND_PASSWORD_MATRIX_SETUP\r\n");
                ...
                case STICK20_CMD_SEND_DEVICE_STATUS:
                     ...
                     * CI_StringOut ("Get
                     * STIC_VOLUME_PASSWHIDDEN_VOLUME_PASSWORD\r\n");
                     * 
                     * StartStick20Command
                     * (STN_VOLUME_PASND_HIDDEN_VOLUME_PASSWORD);
                     * 
                     * // Transfer data to other context HID_CmdGet_u8 =
                     * HTML_SEND_HIDDEN_VOLUME_PASSWORD; memcpy
                     * (HID_String_au8,&report[1],33); break; 
                     */
                    /*
                     * case STICK20_CMD_SEND_HIDDEN_VOLUME_SETUP :
                     * CI_StringOut ("Get
                     * STIC_VOLUME_SETUPHIDDEN_VOLUME_SETUP\r\n");
                     * 
                     * StartStick20Command
                     * (STN_VOLUME_SETND_HIDDEN_VOLUME_SETUP);
                     * 
                     * // Transfer data to other context HID_CmdGet_u8 =
                     * HTML_SEND_HIDDEN_VOLUME_SETUP; memcpy
                     * (HID_String_au8,&report[1],33); break; 
                     */
                ...
                case STICK20_CMD_ENABLE_READONLY_UNCRYPTED_LUN:
                    CI_StringOut
                        ("Get STICK20_CMD_ENABLE_READONLY_UNCRYPTED_LUN\r\n");
                ...
                case STICK20_CMD_ENABLE_READWRITE_UNCRYPTED_LUN:
                    CI_StringOut
                        ("Get STICK20_CMD_ENABLE_READWRITE_UNCRYPTED_LUN\r\n");
                ...
                case STICK20_CMD_CLEAR_NEW_SD_CARD_FOUND:
                    CI_StringOut
                        ("Get STICK20_CMD_CLEAR_NEW_SD_CARD_FOUND\r\n");
                ...
                case STICK20_CMD_SEND_HIDDEN_VOLUME_SETUP:
                    CI_StringOut
                        ("Get STICK20_CMD_SEND_HIDDEN_VOLUME_SETUP\r\n");

                    StartStick20Command
                        (STICK20_CMD_SEND_HIDDEN_VOLUME_SETUP);
                ...
                case STICK20_CMD_SEND_CLEAR_STICK_KEYS_NOT_INITIATED:
                    CI_StringOut
                        ("Get STICK20_CMD_SEND_CLEAR_STICK_KEYS_NOT_INITIATED\r\n");
                ...
                case STICK20_CMD_SEND_LOCK_STICK_HARDWARE:
                    CI_StringOut
                        ("Get STICK20_CMD_SEND_LOCK_STICK_HARDWARE\r\n");

                    StartStick20Command
                        (STICK20_CMD_SEND_LOCK_STICK_HARDWARE);
        ...
        memcpy (&output[OUTPUT_CMD_RESULT_STICK20_STATUS_START],
                (void *) &HID_Stick20Status_st,
                sizeof (HID_Stick20Status_est));
...
u8 cmd_get_status (u8 * report, u8 * output)
{
     ...
     */
    memcpy (output + OUTPUT_CMD_RESULT_OFFSET + 6,
            (u8 *) SLOTS_ADDRESS + GLOBAL_CONFIG_OFFSET, 3);
    memcpy (output + OUTPUT_CMD_RESULT_OFFSET + 9,
            (u8 *) SLOTS_ADDRESS + GLOBAL_CONFIG_OFFSET + 3, 2);
...
{
    output[OUTPUT_CMD_RESULT_OFFSET] =
        StickConfiguration_st.AdminPwRetryCount;
    return 0;
}
...
u8 is_programmed = *((u8 *) (hotp_slots[slot_no]));
        ...
        if (is_programmed == 0x01)
        {
            ...
            itoa ((u32) counter, &output[OUTPUT_CMD_RESULT_OFFSET + 29]);   // Bytes 
                                                                            // after 
                                                                            // OUTPUT_CMD_RESULT_OFFSET+29+8 
                                                                            // is 
                                                                            // unused
...
u8 text[20];
                ...
                CI_StringOut ((char *) text);
                CI_StringOut ("- -");
                memcpy (text, (char *) &output[OUTPUT_CMD_RESULT_OFFSET + 29],
                        8);
                text[8] = 0;
                CI_StringOut ((char *) text);
                CI_StringOut ("-\r\n");
...
#define SYSTEMTIME_TIMEDIFF_FOR_WRITING_INTO_FLASH       (60*60)    // Sec =
                                                                    // 1 hour
...
s32 Timediff_s32;
    ...
    if (60 * 60 * 24 * 365 > now)   // If the local time is before 1971, set
                                    // systemtime
    {
        CI_LocalPrintf ("Local time is not set - set to %ld = ",
                        Newtimestamp_u32);
    ...
    if ((Timediff_s32 > MAX_SYSTEMTIME_TIMEDIFF)
        || (Timediff_s32 < -MAX_SYSTEMTIME_TIMEDIFF))
    {
    ...
    if (Timediff_s32 < -MAX_SYSTEMTIME_TIMEDIFF)
    {
        ...
        return (FALSE); // Timestamp points to a time before the stored time
                        // > something is wrong
    }
...
u32 result = 0;
    ...
    /*
     * CI_LocalPrintf ("challenge:" ); HexPrint (8,(unsigned char*)report +
     * CMD_GC_CHALLENGE_OFFSET); CI_LocalPrintf ("\n\r"); 
     */
...
u8 is_programmed = *((u8 *) (totp_slots[slot_no]));
        ...
        {
            result =
                get_code_from_totp_slot (slot_no, timestamp / (u64) interval);
...
u8 cSecVersion_u8;
    ...
    // Ret_u32 = LA_SC_SendVerify (1,(unsigned char *)card_password); // 1 =
    // user pw
    Ret_u32 =
        LA_OpenPGP_V20_Test_SendAdminPW ((unsigned char *) card_password);
    if (TRUE == Ret_u32)
    {
        res = 0;
    }
...
u32 Ret_u32;
    ...
    Ret_u32 =
        LA_OpenPGP_V20_Test_SendUserPW2 ((unsigned char *) user_password);
    if (TRUE == Ret_u32)
    {
        res = 0;
    }
...
u32 Ret_u32;
    ...
    Ret_u32 =
        LA_OpenPGP_V20_Test_ResetRetryCounter ((unsigned char *)
                                               newUserPassword_au8);
    if (TRUE == Ret_u32)
    {
        res = 0;
...
u32 Ret_u32;
    ...
    if (TRUE == Ret_u32)
    {
        ...
        output[OUTPUT_CMD_RESULT_OFFSET] = Data_u8[6];  // Admin retry
                                                        // counter
...
u32 new_time_minutes = (new_time - 1388534400) / 60;    // 1388534400 =
                                                        // 01.01.2014 00:00
    /*
     * { u8 text[30];
     * 
     ...
     * 
     * CI_StringOut ("new_time = "); itoa (new_time,text); CI_StringOut
     * ((char*)text);
     * 
     * CI_StringOut (" = "); ctime_r ((time_t*)&new_time,(char*)text);
        ...
        || (report[CMD_DATA_OFFSET] == 1))
    {
         ...
         * CI_StringOut ("cmd_set_time: ");
         * 
         * CI_StringOut ("Local time set to = "); itoa (new_time,text);
         * CI_StringOut ((char*)text);
         * 
         * CI_StringOut (" = "); ctime_r ((time_t*)&new_time,(char*)text);
         * CI_StringOut ((char*)text); CI_StringOut ("\r\n"); } 
...
time_t now;
    ...
    for (i = 0; i < tests_number; i++)
    {
        time_min = (current_time - 1388534400) / 60;    // time = minutes
                                                        // after 01.01.2014
                                                        // 00:00
...
u32 Ret_u32;
    ...
    Ret_u32 =
        PWS_GetSlotPassword (report[1], &output[OUTPUT_CMD_RESULT_OFFSET]);
    if (TRUE == Ret_u32)
    {
        output[OUTPUT_CMD_STATUS_OFFSET] = CMD_STATUS_OK;
    }
...
u32 Ret_u32;
    ...
    Ret_u32 =
        PWS_WriteSlotData_1 (report[1], &report[2],
                             &report[2 + PWS_SLOTNAME_LENGTH]);
...
u32 Ret_u32;
    ...
    Ret_u32 =
        LA_OpenPGP_V20_Test_SendAdminPW ((unsigned char *) admin_password);
    if (TRUE != Ret_u32)
    {
        output[OUTPUT_CMD_STATUS_OFFSET] = CMD_STATUS_WRONG_PASSWORD;
        return 1;   // wrong card password
