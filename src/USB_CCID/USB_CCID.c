...
/*
   case CCID_CONTROL_ABORT: CI_TickLocalPrintf ("USB_CCID - CCID_CONTROL_ABORT\r\n"); break; case CCID_CONTROL_GET_CLOCK_FREQUENCIES:
...
u8 CCID_SetATRData_u8 (t_USB_CCID_data_st * USB_CCID_data_pst)
{
    ...
    USB_CCID_data_pst->USB_data[CCID_OFFSET_LENGTH] =
        ISO7816_CopyATR ((u8 *) & USB_CCID_data_pst->USB_data[CCID_OFFSET_XFR_BLOCK_DATA], USB_CCID_MAX_LENGTH);
...
u8 SC_ErrorCode_u8;
    ...
    ErrorCode_u8 = CCID_XfrBlock_u8 (USB_CCID_data_pst, &CCID_AnswerBlockSize_u16, CCID_LevelParameter_u16);
...
u8 SC_ErrorCode_u8;
    ...
    /*
       ...
       USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+3] = CCID_DEFAULT_PARAMETER_WAITING_INTEGER;
       USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+4] = CCID_DEFAULT_PARAMETER_CLOCK_STOP;
       USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+5] = 0x00; USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+6] = 0x00; */
...
void RDR_to_PC_Parameters_v (t_USB_CCID_data_st * USB_CCID_data_pst)
{
    ...
    // Take the send parameter...
    /*
       USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA] = 0x00; USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+1] = 0x00;
       USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+2] = 0x00; USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+3] = 0x00;
       USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+4] = 0x00; USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+5] = 0x00;
       USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+6] = 0x00; */
    /*
       USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA] = CCID_DEFAULT_PARAMETER_FIDI;
       USB_CCID_data_pst->USB_data[CCID_OFFSET_SET_PARAMS_DATA+1] = CCID_DEFAULT_PARAMETER_T01CONVCHECKSUM;
...
{
    /*
       UsbMessageBuffer[OFFSET_BMESSAGETYPE] = RDR_TO_PC_ESCAPE; UsbMessageBuffer[OFFSET_BSTATUS] = CRD_GetSlotStatus();
       UsbMessageBuffer[OFFSET_BERROR] = 0x00;

       if(ErrorCode_u8 != SLOT_NO_ERROR) { UsbMessageBuffer[OFFSET_BSTATUS] += 0x40; UsbMessageBuffer[OFFSET_DWLENGTH] = 0x00;
       UsbMessageBuffer[OFFSET_DWLENGTH+1] = 0x00; UsbMessageBuffer[OFFSET_DWLENGTH+2] = 0x00; UsbMessageBuffer[OFFSET_DWLENGTH+3] = 0x00;
...
{
    /*
       //UsbMessageBuffer[OFFSET_BMESSAGETYPE] = 0x00; UsbMessageBuffer[OFFSET_DWLENGTH] = 0x00; UsbMessageBuffer[OFFSET_DWLENGTH+1] = 0x00;
       UsbMessageBuffer[OFFSET_DWLENGTH+2] = 0x00; UsbMessageBuffer[OFFSET_DWLENGTH+3] = 0x00; UsbMessageBuffer[OFFSET_BSTATUS] = 0x40 +
       CRD_GetSlotStatus(); UsbMessageBuffer[OFFSET_BERROR] = 0x00; UsbMessageBuffer[OFFSET_BCHAINPARAMETER] = 0x00; */
}
...
void CDR_to_USB_NotifySlotChange_v (t_USB_CCID_data_st * USB_CCID_data_pst)
{
    /*
       ...
       if( CRD_GetSlotStatus() == CRD_NOTPRESENT ) { UsbIntMessageBuffer[OFFSET_INT_BMSLOTICCSTATE] = 0x02; } else {
...
{
    /*
       unsigned char HwErrorCode = SLOT_NO_ERROR; // unsigned char ErrorCode_u8;

       UsbIntMessageBuffer[OFFSET_INT_BMESSAGETYPE] = RDR_TO_PC_HARDWAREERROR; UsbIntMessageBuffer[OFFSET_INT_BSLOT] = 0x00;
       UsbIntMessageBuffer[OFFSET_INT_BSEQ] = UsbMessageBuffer[OFFSET_BSEQ]; // ErrorCode_u8 = CCID_GetHwError_u8(&HwErrorCode);
