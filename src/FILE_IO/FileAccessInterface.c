...
Fs_index sav_index;
    ...
    while (1)
    {
        ...
        {
            // CI_LocalPrintf ("Can't select %s - %d -
            // %s\n\r",Filename_pu8,fs_g_status,
            // IBN_FileSystemErrorText(fs_g_status));
            break;
        }
...
U8 CopyStatus_u8;
    ...
    nav_file_name ((FS_STRING) SourceFilename_pu8, MAX_FILE_PATH_LENGTH,
                   FS_NAME_GET, TRUE);
