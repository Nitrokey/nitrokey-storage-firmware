...
void *p;
    ...
    AES_StorageKeyEncryption (PWS_SLOT_LENGTH, (void *) Slot_st,
                              AesKeyPointer_pu8, AES_PMODE_CIPHER);
...
u8 *AesKeyPointer_pu8;
    ...
    AES_StorageKeyEncryption (PWS_SLOT_LENGTH, (void *) Slot_st,
                              AesKeyPointer_pu8, AES_PMODE_DECIPHER);
...
u32 Ret_u32;
    ...
    Ret_u32 = LA_SC_SendVerify (2, (unsigned char *) password); // 2 = user
                                                                // pw
    if (TRUE != Ret_u32)
    {
        CI_LocalPrintf (" *** FAIL ***\r\n");
