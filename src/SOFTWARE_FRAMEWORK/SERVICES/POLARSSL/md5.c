 ...
 * MD5 context setup
 */
void md5_starts_1 (md5_context * ctx)
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
 ...
 * MD5 process buffer
 */
void md5_update_1 (md5_context * ctx, unsigned char* input, int ilen)
{
    int fill;
    unsigned long left;
 ...
 * MD5 final digest
 */
void md5_finish_1 (md5_context * ctx, unsigned char output[16])
{
 ...
 */
void md5_1 (unsigned char* input, int ilen, unsigned char output[16])
{
    md5_context ctx;
 ...
 */
int md5_file_1 (char* path, unsigned char output[16])
{
    FILE* f;
    size_t n;
    md5_context ctx;
 ...
 */
void md5_hmac_starts_1 (md5_context * ctx, unsigned char* key, int keylen)
{
    int i;
 ...
 */
void md5_hmac_update_1 (md5_context * ctx, unsigned char* input, int ilen)
{
    md5_update (ctx, input, ilen);
}
 ...
 */
void md5_hmac_finish_1 (md5_context * ctx, unsigned char output[16])
{
 ...
 */
void md5_hmac_1 (unsigned char* key, int keylen, unsigned char* input, int ilen, unsigned char output[16])
{
    md5_context ctx;
 ...
 * Checkup routine
 */
int md5_self_test_1 (int verbose)
{
    int i, buflen;
    unsigned char buf[1024];
