...
static void des_setkey (unsigned long SK[32], unsigned char key[8])
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        *SK++ = ((X << 4) & 0x24000000) | ((X << 28) & 0x10000000)
            ...
            | ((Y >> 3) & 0x00000008) | ((Y >> 18) & 0x00000004) | ((Y >> 26) & 0x00000002) | ((Y >> 24) & 0x00000001);
        ...
        *SK++ = ((X << 15) & 0x20000000) | ((X << 17) & 0x10000000)
            ...
            | ((Y >> 7) & 0x00000020) | ((Y >> 3) & 0x00000011) | ((Y << 2) & 0x00000004) | ((Y >> 21) & 0x00000002);
    }
}
...
int des_self_test (int verbose)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        if (verbose != 0)
            printf ("  DES%c-ECB-%3d (%s): ", (u == 0) ? ' ' : '3', 56 + u * 56, (v == DES_DECRYPT) ? "dec" : "enc");
        ...
        if ((v == DES_DECRYPT && memcmp (buf, des3_test_ecb_dec[u], 8) != 0) || (v != DES_DECRYPT && memcmp (buf, des3_test_ecb_enc[u], 8) != 0))
        {
            if (verbose != 0)
                printf ("failed\n");
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        if (verbose != 0)
            printf ("  DES%c-CBC-%3d (%s): ", (u == 0) ? ' ' : '3', 56 + u * 56, (v == DES_DECRYPT) ? "dec" : "enc");
    ...
    unsigned char tmp[8];
        ...
        if ((v == DES_DECRYPT && memcmp (buf, des3_test_cbc_dec[u], 8) != 0) || (v != DES_DECRYPT && memcmp (buf, des3_test_cbc_enc[u], 8) != 0))
        {
            if (verbose != 0)
                printf ("failed\n");
