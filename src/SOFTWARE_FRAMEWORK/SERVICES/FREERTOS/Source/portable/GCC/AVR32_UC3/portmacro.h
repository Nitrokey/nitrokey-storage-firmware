 ...
 * ! \file
 * *********************************************************************
 * \brief FreeRTOS port header for AVR32 UC3. - Compiler: GNU GCC for AVR32
...
#define configTICK_TC_IRQ             ATPASTE3(AVR32_TC,configTICK_TC_CHANNEL,_IRQ1)
...
{                                                                                  \
  ...
  __asm__ __volatile__ (                                                           \
    ...
    // R7
    // ulCriticalNesting
    // (*) automatically done for AVR32_INTC_INT0..AVR32_INTC_INT3, but not
    // for SCALL
