...
{
    /*
     * The list structure contains a list item which is used to mark the end
     * of the list.  To initialise the list the list end is inserted as the
     * only list entry. 
     */
     ...
     * it remains at the end of the list. 
     */
...
volatile xListItem *pxIndex;
     ...
     * pvListGetOwnerOfNextEntry.  This means it has to be the item pointed
     * to by the pxIndex member. 
     */
...
portTickType xValueOfInsertion;
     ...
     * the new list item should be placed after it.  This ensures that TCB's
     * which are stored in ready lists (all of which have the same ulListItem
     * value) get an equal share of the CPU.  However, if the xItemValue is
     * the same as the back marker the iteration loop below will not end.
     * This means we need to guard against this by checking the value first
     * and modifying the algorithm slightly if necessary. 
     */
