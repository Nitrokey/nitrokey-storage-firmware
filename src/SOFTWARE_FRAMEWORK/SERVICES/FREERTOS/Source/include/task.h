...
#define tskIDLE_PRIORITY			( ( unsigned portBASE_TYPE ) 0 )
    ...
    {
        volatile portSTACK_TYPE* pxTopOfStack;  /* < Points to the location of the last item placed on the tasks stack.  THIS MUST BE THE FIRST
 ...
 *----------------------------------------------------------*/
     ...
     */
    signed portBASE_TYPE xTaskGenericCreate (pdTASK_CODE pvTaskCode, const signed char* const pcName, unsigned short usStackDepth, void* pvParameters,
