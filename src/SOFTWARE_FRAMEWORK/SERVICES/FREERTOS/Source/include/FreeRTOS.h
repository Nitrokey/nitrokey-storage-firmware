...
#define INCLUDE_xTaskGetSchedulerState 0
    ...
    /*
     * xTaskGetCurrentTaskHandle is used by the priority inheritance
     * mechanism within the mutex implementation so must be available if
     * mutexes are used. 
     */
...
#ifndef traceSTART
    /*
     * Used to perform any necessary initialisation - for example, open a
     * file into which trace is to be written. 
     */
#define traceSTART()
#endif
...
#ifndef traceEND
    /*
     * Use to close a trace, for example close a file into which trace has
     * been written. 
     */
#define traceEND()
#endif
...
#define traceBLOCKING_ON_QUEUE_RECEIVE( pxQueue )
     ...
     * queue/mutex/semaphore.  pxQueue is a pointer to the
     * queue/mutex/semaphore upon which the write was attempted.
     * pxCurrentTCB points to the TCB of the task that attempted the write. 
     */
