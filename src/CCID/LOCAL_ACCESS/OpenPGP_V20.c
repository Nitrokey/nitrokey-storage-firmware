...
int nRet;
    ...
    /*
       ...
       01 24 01 gpg: DBG: response: sw=9000 deadline=0 gpg: DBG: dump: 2D */
...
int LA_OpenPGP_V20_GetPublicKey (typeAPDU * tSC, int nKind, int nReceiveLength, unsigned char** cReceiveData)
{
    ...
    /* Not necessary n = tSC->nReceiveDataLen; if (n < nReceiveLength) { n = nReceiveLength; } */
...
int LA_OpenPGP_V20_Test (void)
{
    ...
    /*
       nRet = LA_OpenPGP_V20_GetData (&tSC_OpenPGP_V20,0x00,0x5E); if (FALSE == nRet) { return (FALSE); } */
...
void IBN_SC_Tests (unsigned char nParamsGet_u8, unsigned char CMD_u8, unsigned int Param_u32, unsigned char* String_pu8)
{
    ...
    switch (CMD_u8)
    {
        ...
        case 1:
            ...
            Ret_u32 = LA_OpenPGP_V20_Verify (&tSC_OpenPGP_V20, 1, strlen ((char *) LocalString_au8), LocalString_au8);  // 6, (unsigned
                                                                                                                        // char*)"123456");
