 ...
 * #define TOOL_DFU_ISP_CONFIG_WORD_START_APPL_0 (0x929E0E62) #define
 * TOOL_DFU_ISP_CONFIG_WORD_START_APPL_0_0 (0x92) #define
 * TOOL_DFU_ISP_CONFIG_WORD_START_APPL_0_1 (0x9E) #define
 * TOOL_DFU_ISP_CONFIG_WORD_START_APPL_0_2 (0x0E) #define
 * TOOL_DFU_ISP_CONFIG_WORD_START_APPL_0_3 (0x62)
 * 
 * #define TOOL_DFU_ISP_CONFIG_WORD_START_APPL_1 (0xE11EFCDE) #define
 * TOOL_DFU_ISP_CONFIG_WORD_START_APPL_1_0 (0xE1) #define
 * TOOL_DFU_ISP_CONFIG_WORD_START_APPL_1_1 (0x1E) #define
 * TOOL_DFU_ISP_CONFIG_WORD_START_APPL_1_2 (0xFC) #define
...
void DFU_DisableFirmwareUpdate (void)
{
    ...
    flashc_write_gp_fuse_bit (30, 0);   // Set SP_IO_COND_EN = 0 for DUF
                                        // 1.0.3
    flashc_write_gp_fuse_bit (31, 0);   // Set to 0 to start application for
                                        // DUF 1.0.3
...
void DFU_EnableFirmwareUpdate (void)
{
    ...
    flashc_erase_gp_fuse_bit (30, 0);   // Set SP_IO_COND_EN = 1 for DUF
                                        // 1.0.3
    flashc_erase_gp_fuse_bit (31, 0);   // Set to 1 to start bootloader for
                                        // DUF 1.0.3

    flashc_write_gp_fuse_bit (30, 1);   // Set SP_IO_COND_EN = 1 for DUF
                                        // 1.0.3
    flashc_write_gp_fuse_bit (31, 1);   // Set to 1 to start application for
                                        // DUF 1.0.3
}
