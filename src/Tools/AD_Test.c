...
void AD_LogHourData_v (void)
{
    ...
    AD_Data_st.ValueHoursTime_u16[AD_Data_st.PointerHoursEnd_u8] = AD_Data_st.ValueMinutesTime_u32[0];
...
{
    AD_Data_st.ValueMinutesTime_u32[AD_Data_st.PointerMinutesEnd_u8] = AD_Data_st.LastStartSec_u32;
    AD_Data_st.ValueMinMinutes_u16[AD_Data_st.PointerMinutesEnd_u8] = AD_Data_st.FilterMin_u16;
    AD_Data_st.ValueMaxMinutes_u16[AD_Data_st.PointerMinutesEnd_u8] = AD_Data_st.FilterMax_u16;
...
u16 AD_GetData_u16 (void)
{
    ...
    {
        Sum_32 = (AD_Data_st.Filter_Sum_u32) / AD_Data_st.Filter_SampleCount_u32;
    }

    // Check for event
    if (TRUE == AD_EventBufferActiv_u16)
    {
        if ((0 == AD_EventBufferStopInSamples_u16) && (0 != AD_Data_st.LastValue_u32))
        {
    ...
    {
        NextMinuteLog_u32 = AD_Data_st.LastStartSec_u32 - AD_Data_st.LastStartSec_u32 % 60 + 60;
        NextHourLog_u32 = AD_Data_st.LastStartSec_u32 - AD_Data_st.LastStartSec_u32 % 3600 + 3600;
    }
...
u32 now_ms;
    ...
    sprintf ((char *) Text_pu8, "%2d.%02d.%02d %2d:%02d:%02d %3d ms - Min %4d Max %4d %4d  - %4d\r\n", tm_st.tm_mday,
             tm_st.tm_mon + 1,
             tm_st.tm_year - 100,
             tm_st.tm_hour,
             tm_st.tm_min,
             tm_st.tm_sec,
             now_ms,
             AD_Data_st.FilterMin_u16, AD_Data_st.FilterMax_u16, AD_Data_st.LastValue_u32, AD_Data_st.FilterMax_u16 - AD_Data_st.FilterMin_u16);
}
...
u32 i;
    ...
    sprintf ((char *) Text_pu8, "%2d.%02d.%02d %2d:%02d:%02d - Min %4d Max %4d - %4d\r\n", tm_st.tm_mday,
             tm_st.tm_mon + 1,
             tm_st.tm_year - 100,
             tm_st.tm_hour,
             tm_st.tm_min,
             ...
             AD_Data_st.ValueMaxMinutes_u16[i], AD_Data_st.ValueMaxMinutes_u16[i] - AD_Data_st.ValueMinMinutes_u16[i]);
}
...
u32 i;
    ...
    sprintf ((char *) Text_pu8, "%2d.%02d.%02d %2d:%02d:%02d - Min %4d Max %4d - %4d\r\n", tm_st.tm_mday,
             ...
             tm_st.tm_min,
             tm_st.tm_sec,
             AD_Data_st.ValueMinHours_u16[i], AD_Data_st.ValueMaxHours_u16[i], AD_Data_st.ValueMaxHours_u16[i] - AD_Data_st.ValueMinHours_u16[i]);
}
...
u32 now_ms;
    ...
    sprintf ((char *) Text_pu8, "%2d:%02d:%02d %3d ms - Min %4d Max %4d - %4d - %4d\r\n",
             tm_st.tm_hour,
             tm_st.tm_min,
             tm_st.tm_sec,
             now_ms, AD_Data_st.FilterMin_u16, AD_Data_st.FilterMax_u16, Value_u16, AD_Data_st.FilterMax_u16 - AD_Data_st.FilterMin_u16);
}
...
void AD_PrintSummary (void)
{
    ...
    n = 0;
    for (i = AD_Data_st.PointerMinutesStart_u8; i != AD_Data_st.PointerMinutesEnd_u8; i++)
    {
        ...
        localtime_r ((time_t *) & AD_Data_st.ValueMinutesTime_u32[i], &tm_st);
        CI_LocalPrintf ("%2d %2d: %02d.%02d.%02d %2d:%02d:%02d ", n, i, tm_st.tm_mday, tm_st.tm_mon + 1, tm_st.tm_year - 100, tm_st.tm_hour,
    ...
    n = 0;
    for (i = AD_Data_st.PointerHoursStart_u8; i != AD_Data_st.PointerHoursEnd_u8; i++)
    {
        if (AD_HOURS_COUNT <= i)
        {
            i = 0;
        ...
        localtime_r ((time_t *) & AD_Data_st.ValueHoursTime_u16[i], &tm_st);
        CI_LocalPrintf ("%2d: %02d.%02d.%02d %2d:%02d:%02d ", n, tm_st.tm_mday, tm_st.tm_mon + 1, tm_st.tm_year - 100, tm_st.tm_hour, tm_st.tm_min,
                        tm_st.tm_sec);
        CI_LocalPrintf ("min %4d  max %4d - %4d\r\n", AD_Data_st.ValueMinHours_u16[i], AD_Data_st.ValueMaxHours_u16[i],
                        AD_Data_st.ValueMaxHours_u16[i] - AD_Data_st.ValueMinHours_u16[i]);
        // Todo: find bug
        n++;
        if (AD_HOURS_COUNT <= n)
        {
...
{
    /*
       switch (Filetype_u8) { case AD_FILEPATH_MINUTE : return (AD_FILEPATH_TXT_MINUTE);
...
time_t now;
    ...
    switch (Filetype_u8)
    {
        case AD_FILEPATH_MINUTE:
            sprintf ((char *) Time_u8, "MIN_%04d%02d%02d_%02d.txt", 1900 + tm_st.tm_year, tm_st.tm_mon + 1, tm_st.tm_mday, tm_st.tm_hour);
            break;

        case AD_FILEPATH_HOUR:
            sprintf ((char *) Time_u8, "HOUR_%04d%02d%02d.txt", 1900 + tm_st.tm_year, tm_st.tm_mon + 1, tm_st.tm_mday);
            break;

        case AD_FILEPATH_DAY:
            sprintf ((char *) Time_u8, "DAY_%04d%02d%02d.txt", 1900 + tm_st.tm_year, tm_st.tm_mon + 1, tm_st.tm_mday);
            break;

        case AD_FILEPATH_EVENT:
            sprintf ((char *) Time_u8, "EVENT_%04d%02d%02d.txt", 1900 + tm_st.tm_year, tm_st.tm_mon + 1, tm_st.tm_mday);
            break;

        case AD_FILEPATH_DATA:
            sprintf ((char *) Time_u8, "DATA_%04d%02d%02d_%02d.txt", 1900 + tm_st.tm_year, tm_st.tm_mon + 1, tm_st.tm_mday, tm_st.tm_hour);
            break;
...
struct tm tm_st_old;
    ...
    if ((tm_st_old.tm_year == tm_st.tm_year) && (tm_st_old.tm_mon == tm_st.tm_mon) && (tm_st_old.tm_mday == tm_st.tm_mday))
    {
        return (TRUE);
    }
    ...
    sprintf ((char *) Path_u8, "%2d%02d%02d", tm_st.tm_year - 100, tm_st.tm_mon + 1, tm_st.tm_mday);
...
struct tm tm_st;
    ...
    sprintf ((char *) Text_u8, "E_%2d%02d%02d.txt", tm_st.tm_hour, tm_st.tm_min, tm_st.tm_sec);

    FileID_s32 = open ((char *) Text_u8, O_CREAT | O_APPEND);
    if (0 > FileID_s32)
    {
        CI_LocalPrintf ("Error open %s - %d - %s\r\n", Text_u8, fs_g_status, IBN_FileSystemErrorText (fs_g_status));
        return (FALSE);
    }

    localtime_r ((time_t *) & time_u32, &tm_st);

    sprintf ((char *) Text_u8, "Event at %02d.%02d.%02d %2d:%02d:%02d\n", tm_st.tm_mday, tm_st.tm_mon + 1, tm_st.tm_year - 100, tm_st.tm_hour,
             tm_st.tm_min, tm_st.tm_sec);
    ...
    {
        sprintf ((char *) Text_u8, "%4d;%5d\n", i, AD_EventBuffer_u16[Pointer_u16]);
        Ret_s32 = write (FileID_s32, Text_u8, strlen ((char *) Text_u8));
...
struct tm tm_st;
    ...
    if (0 > FileID_s32)
    {
        CI_LocalPrintf ("AD_FileIO_SaveLocalTime_u8: Error open %s - %d - %s\r\n", AD_FILE_LOCALTIME, fs_g_status,
    ...
    sprintf ((char *) Text_u8, "%12ld - %02d.%02d.%02d %2d:%02d:%02d ", (unsigned long) LocalTime_u32, tm_st.tm_mday, tm_st.tm_mon + 1,
    ...
    if (-1 == Ret_s32)
    {
        CI_LocalPrintf ("AD_FileIO_SaveLocalTime_u8: write FAIL - %d - %s\r\n", fs_g_status, IBN_FileSystemErrorText (fs_g_status));
    }
    /*
       if (TRUE != fat_cache_flush ()) { CI_LocalPrintf ("AD_FileIO_SaveLocalTime_u8: fat_cache_flush FAIL - %d - %s\r\n",fs_g_status,
       IBN_FileSystemErrorText(fs_g_status)); } */
    Ret_s32 = close (FileID_s32);
    if (-1 == Ret_s32)
    {
...
u8 Text_u8[15];
    ...
    if (0 > FileID_s32)
    {
        CI_LocalPrintf ("Error open %s - %d - %s\r\n", AD_FILE_LOCALTIME, fs_g_status, IBN_FileSystemErrorText (fs_g_status));
        return (FALSE);
    }
...
/*
   u8 AD_FileIO_AppendData_u8 (u8 *Filename_pu8,u32 Data_u32) { s32 FileID_s32; s32 Ret_s32; u8 Text_u8[20];

   // FileID_s32 = open ("test.txt",O_CREAT|O_APPEND); FileID_s32 = open ((char*)Filename_pu8,O_CREAT|O_APPEND); if (0 > FileID_s32) { CI_LocalPrintf
   ("Error open %s - %d - %s\r\n",Filename_pu8,fs_g_status, IBN_FileSystemErrorText(fs_g_status)); return (FALSE); }

   // CI_LocalPrintf ("%2d.%02d.%02d %2d:%02d:%02d %3d ms -
   ",tm_st.tm_mday,tn,tm_st.tm_sec,n_st.tm_year-100,tm_st.tm_hour,tm_st.tm_min,tm_st.tm_sec,now_ms);

   sprintf ((char*)Text_u8,"Tick %d %d\r\n",(int)xTickCount,Data_u32); Ret_s32 = write (FileID_s32,Text_u8,strlen ((char*)Text_u8));

   // CI_LocalPrintf ("Write = %d \r\n",Ret_s32);

   if (TRUE != fat_cache_flush ()) { CI_LocalPrintf ("fat_cache_flush FAIL - %d - %s\r\n",fs_g_status, IBN_FileSystemErrorText(fs_g_status)); }

   Ret_s32 = close (FileID_s32); if (-1 == Ret_s32) { CI_LocalPrintf ("Close = %d \r\n",Ret_s32); }
...
void AD_LOG_WriteDataToFile (void)
{
    ...
    if (600 == LastMinuteLogTime_u32)
    {
        ...
        AD_FileIO_AppendText_u8 (AD_LOG_GetFilename (AD_FILEPATH_MINUTE), Text_u8);
    ...
    if (36000 == LastHourLogTime_u32)
    {
        ...
        AD_FileIO_AppendText_u8 (AD_LOG_GetFilename (AD_FILEPATH_HOUR), Text_u8);
...
void AD_LOG_init (void)
{
    ...
    xTaskCreate (AD_LOG_task, configTSK_AD_LOG_NAME, configTSK_AD_LOG_STACK_SIZE, NULL, configTSK_AD_LOG_PRIORITY, NULL);
